...
import { Client, ClientApproval, ApprovalRequest } from '@app/lib/models/client';
import { isNonNull } from '@app/lib/preconditions';
import { translateClient, translateApproval } from '@app/lib/api_translation/client';
import { translateFlowResult, translateFlow, translateScheduledFlow } from '@app/lib/api_translation/flow';
import { AnyObject } from '@app/lib/api/api_interfaces';
import { translateApproverSuggestions } from '@app/lib/api_translation/user';
import { ClientPageState, FlowInConfiguration, StartFlowState } from './client_page_data_structures';
import { Observable, combineLatest, timer, of, Subject } from 'rxjs';
import {
  Flow,
  ScheduledFlow,
  FlowResultSet,
  updateFlowListEntryResultSet,
  FlowListEntry, FlowDescriptor,
  FlowResultsQuery,
  FlowResultSetState,
  flowListEntryFromFlow,
  FlowState } from '@app/lib/models/flow';
import {
  tap,
  map,
  filter,
